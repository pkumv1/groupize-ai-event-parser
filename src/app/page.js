...
import AimeIntro from '@/components/AimeIntro'
...
export default function Home() {
  ...
  const extractText = async () => {
    ...
    try {
      ...
      toast.success('Text extracted successfully by Aime!')
      return data.text
    } catch (error) {
  ...
  const analyzeDocument = async () => {
    ...
    try {
      ...
      if (data.parsing_error) {
        ...
        toast.success('Document analyzed successfully by Aime!')
      }
        ...
        <div className="main-content">
          ...
          {file && (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginTop: '2rem' }}>
              ...
              <div>
                <h3 className="section-header">🤖 Aime Analysis Controls</h3>
                <AnalysisControls
                  file={file}
          ...
          {parsedData && (
            <div style={{ marginTop: '3rem' }}>
              <h2 className="section-header">📊 Aime's Extracted Event Data</h2>
